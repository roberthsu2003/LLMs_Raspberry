...
一旦您熟悉基礎 Action 的掛載與操作邏輯，可以嘗試挑戰以下進階技巧（實作 Base64 檔案下載、表格導出、進階 HTML 渲染）：

1. [👉 進階 Action 範例 1：導出為 Word 檔案](./導出為Word檔.md)
2. [👉 進階 Action 範例 2：導出為 Excel 檔案](./導出為Excel檔.md)
3. [👉 進階 Action 範例 3：多重格式導出選擇器](./多重格式導出.md)
