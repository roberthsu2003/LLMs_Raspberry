...
// 顯示功能資訊
function showFeatureInfo(category: string): void {
...
// 初始化連接線動畫
function initConnectionLines(): void {
  ...
  function createLines(): void {
    ...
    for (let i = 0; i < cardsArray.length - 1; i++) {
      const card1 = cardsArray[i] as HTMLElement;
      const card2 = cardsArray[i + 1] as HTMLElement;
